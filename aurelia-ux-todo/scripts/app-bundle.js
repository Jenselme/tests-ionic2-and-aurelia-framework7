...
define('text!app.html', ['module'], function(module) { module.exports = "<template><require from=\"./reset.css\"></require><require from=\"./app.css#ux\"></require><nav styles.nav if.bind=\"showNavigationMenu\"><a href=\"#/home\"><img styles.logo src=\"../assets/aurelia-icon-128x128.png\"> </a><span styles.product-name>TODO application with Aurelia UX</span><ul styles.nav-list><template repeat.for=\"[category, routes] of router.navigation | categories\"><li styles.nav-category><span>${category.title}</span></li><li styles.nav-item repeat.for=\"nav of routes\" class=\"${nav.isActive ? 'active' : ''}\"><a href.bind=\"nav.href\">${nav.title}</a></li></template></ul></nav><section styles.main><header styles.header><h1 styles.header-h1>${router.currentInstruction.config.navModel.title}</h1><a styles.clickable target=\"_self\" click.delegate=\"toggleNavigationMenu()\"><i styles.header-burger class=\"fa fa-bars\" aria-hidden=\"true\"></i></a></header><router-view styles.page></router-view></section></template>"; });
...
define('text!home.html', ['module'], function(module) { module.exports = "<template><require from=\"./common.css#ux\"></require><main styles.main><h2 styles.header>What is Aurelia UX?</h2><p styles.description>Aurelia UX is a companion framework to Aurelia. While Aurelia focuses on being a <em>front-end framework</em> by providing core capabilities you need to build apps, such as templating, binding and routing, Aurelia UX focuses on being a <em>user experience framework</em> by providing higher-level capabilities such as design languages, theming and components.</p><p styles.description>Aurelia UX is still in a very early stage but we'd love for you to play with it and consider contributing. We'll keep this app updated as we add new features so it's easy for you to track our progress.</p></main></template>"; });
...
define('text!pages/todo.html', ['module'], function(module) { module.exports = "<template>TODO</template>"; });
